...
int http_parse(struct http_request * structured_request, const unsigned char * request, size_t request_length); // guarda memoria para la request (sin incluir el pointer dado)
